...
{
    public class TokenRegister: IToken<TokenRegister>
    {

        private readonly JwtSetting jwtSettings;
        private readonly LocalDbContext db;
        private readonly IClaimsUser<ClaimsRegister> claim;

        public TokenRegister(JwtSetting jwtSettings, LocalDbContext db, IClaimsUser<ClaimsRegister> claim)
        {
